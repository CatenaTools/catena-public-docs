...
{% tabs %}
    {% tab label="Windows" %}
        ...
        1. Download the installer for the .NET SDK from [this page](https://dotnet.microsoft.com/en-us/download/dotnet/8.0). If you need to determine your computers architecture (x64, x86, or Arm64) you can:
            1. Click Start
